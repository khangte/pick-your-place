...
## 💡 프로젝트 주제  
서울시로 이사·이주를 고려하는 많은 사람들을 위해 서울시 인프라 공공데이터를 기반으로, '행정동'별 점수를 산출하여 거주지를 추천하는 지도 대시보드 시스템
